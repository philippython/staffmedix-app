...
import { usePasswordResetConfirmMutation } from "../../services/authApi";
...
export default function PasswordResetConfirm() {
  ...
  const [resetPasswordConfirm, { isLoading: loading, isError: error }] =
  ...
  async function handleResetConfirm() {
    ...
    if (password === confirmPassword) {
      try {
        ...
        setErrMsg("Password is too common");
  ...
  return (
    <div className={styles.passwordResetContainer}>
      <div className={styles.authForm}>
        ...
        <Button variant={"coloredButton"} onClick={handleResetConfirm}>
          {loading ? "Resetting Password..." : "Reset Pssword"}
        </Button>

        <Link className={styles.backLink} to={"/auth"}>
          &larr; Back to Login
        </Link>
      </div>
    </div>
